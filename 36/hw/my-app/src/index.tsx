...
const genres = new Set(
  films.reduce((acc: Array<string>, film: IFilm) => {
    return acc.concat(film.genre);
  }, [])
);
...
const getnewArr = (films: Array<IFilm>): Array<INewFilm> => {
...
const filterByYear = (films: Array<IFilm>, year: number): Array<IFilm> => {
...
const filterByTitle = (films: Array<IFilm>, str: string): Array<IFilm> => {
  return films.filter((film) => film.title.includes(str));
};
...
const filterByTitleAndPlot = (
  films: Array<IFilm>,
  str: string
): Array<IFilm> => {
  return films.filter(
    (film) => film.title.includes(str) || film.plot.includes(str)
  );
};
